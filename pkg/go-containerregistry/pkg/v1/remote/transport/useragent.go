...
var (
	...
	// -ldflags="-X 'github.com/docker/model-runner/pkg/go-containerregistry/pkg/v1/remote/transport.Version=$TAG'"
	Version string
...
const (
	...
	moduleName       = "github.com/docker/model-runner/pkg/go-containerregistry"
)
