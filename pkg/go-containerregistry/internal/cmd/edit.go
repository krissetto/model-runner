...
import (
	...
	"github.com/docker/model-runner/pkg/go-containerregistry/internal/editor"
...
func editConfig(ctx context.Context, in io.Reader, out io.Writer, src, dst string, options ...crane.Option) (name.Reference, error) {
	...
	if config.Data != nil && verify.Descriptor(config) == nil {
		// https://github.com/docker/model-runner/pkg/go-containerregistry/issues/1552#issuecomment-1452653875
